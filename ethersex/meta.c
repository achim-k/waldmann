...
int16_t parse_cmd_i2c_pca9685_set_led (char *cmd, char *output, uint16_t len);
int16_t parse_cmd_i2c_pca9685_set_mode (char *cmd, char *output, uint16_t len);
#endif
...
#endif
#ifdef I2C_DS1631_SUPPORT
const char PROGMEM ecmd_i2c_ds1631_read_temperature_text[] = "ds1631 temp";
const char PROGMEM ecmd_i2c_ds1631_set_power_state_text[] = "ds1631 convert";
#endif
#ifdef I2C_TSL2550_SUPPORT
const char PROGMEM ecmd_i2c_tsl2550_show_lux_level_text[] = "tsl2550 lux";
const char PROGMEM ecmd_i2c_tsl2550_set_power_state_text[] = "tsl2550 power";
const char PROGMEM ecmd_i2c_tsl2550_set_operating_mode_text[] = "tsl2550 mode";
#endif
#ifdef I2C_PCA9531_SUPPORT
const char PROGMEM ecmd_i2c_pca9531_text[] = "pca9531";
#endif
#ifdef I2C_PCA9685_SUPPORT
const char PROGMEM ecmd_i2c_pca9685_set_led_text[] = "pca9685s";
const char PROGMEM ecmd_i2c_pca9685_set_mode_text[] = "pca9685m";
#endif
#ifdef I2C_PCF8574X_SUPPORT
...
#endif
#ifdef FHT_SEND_SUPPORT
const char PROGMEM ecmd_fht_send_text[] = "fht send";
#endif
#ifdef FS20_RECEIVE_SUPPORT
...
#endif
#ifdef I2C_DS1631_SUPPORT
	{ ecmd_i2c_ds1631_read_temperature_text, parse_cmd_i2c_ds1631_read_temperature },
	{ ecmd_i2c_ds1631_set_power_state_text, parse_cmd_i2c_ds1631_set_power_state },
#endif
#ifdef I2C_TSL2550_SUPPORT
	{ ecmd_i2c_tsl2550_show_lux_level_text, parse_cmd_i2c_tsl2550_show_lux_level },
	{ ecmd_i2c_tsl2550_set_power_state_text, parse_cmd_i2c_tsl2550_set_power_state },
	{ ecmd_i2c_tsl2550_set_operating_mode_text, parse_cmd_i2c_tsl2550_set_operating_mode },
#endif
#ifdef I2C_PCA9531_SUPPORT
	{ ecmd_i2c_pca9531_text, parse_cmd_i2c_pca9531 },
#endif
#ifdef I2C_PCA9685_SUPPORT
	{ ecmd_i2c_pca9685_set_led_text, parse_cmd_i2c_pca9685_set_led },
	{ ecmd_i2c_pca9685_set_mode_text, parse_cmd_i2c_pca9685_set_mode },
#endif
#ifdef I2C_PCF8574X_SUPPORT
...
#endif
#ifdef FHT_SEND_SUPPORT
	{ ecmd_fht_send_text, parse_cmd_fht_send },
#endif
#ifdef FS20_RECEIVE_SUPPORT
...
int16_t parse_cmd_enc_dump (char *cmd, char *output, uint16_t len);
#endif
int16_t parse_cmd_df_status (char *cmd, char *output, uint16_t len);
int16_t parse_cmd_fs_format (char *cmd, char *output, uint16_t len);
int16_t parse_cmd_fs_list (char *cmd, char *output, uint16_t len);
int16_t parse_cmd_fs_mkfile (char *cmd, char *output, uint16_t len);
int16_t parse_cmd_fs_remove (char *cmd, char *output, uint16_t len);
int16_t parse_cmd_fs_truncate (char *cmd, char *output, uint16_t len);
#ifdef DEBUG_FS
int16_t parse_cmd_fs_inspect_node (char *cmd, char *output, uint16_t len);
int16_t parse_cmd_fs_inspect_inode (char *cmd, char *output, uint16_t len);
#endif
#ifndef TEENSY_SUPPORT
#ifdef UIP_SUPPORT
#ifndef IPV6_SUPPORT
...
const char PROGMEM ecmd_enc_dump_text[] = "enc dump";
#endif
const char PROGMEM ecmd_df_status_text[] = "df status";
const char PROGMEM ecmd_fs_format_text[] = "fs format";
const char PROGMEM ecmd_fs_list_text[] = "fs list";
const char PROGMEM ecmd_fs_mkfile_text[] = "fs mkfile ";
const char PROGMEM ecmd_fs_remove_text[] = "fs remove ";
const char PROGMEM ecmd_fs_truncate_text[] = "fs truncate ";
#ifdef DEBUG_FS
const char PROGMEM ecmd_fs_inspect_node_text[] = "fs inspect node ";
const char PROGMEM ecmd_fs_inspect_inode_text[] = "fs inspect inode ";
#endif
#ifndef TEENSY_SUPPORT
#ifdef UIP_SUPPORT
#ifndef IPV6_SUPPORT
...
#endif
#endif
const char PROGMEM ecmd_ntp_query_text[] = "ntp query";
const char PROGMEM ecmd_ntp_server_text[] = "ntp server";
const char PROGMEM ecmd_ntp_status_text[] = "ntp status";
#ifdef I2C_DETECT_SUPPORT
const char PROGMEM ecmd_i2c_detect_text[] = "i2c detect";
#endif
#ifdef I2C_GENERIC_SUPPORT
...
const struct ecmd_command_t PROGMEM ecmd_cmds[] = {
	...
	{ ecmd_enc_dump_text, parse_cmd_enc_dump },
#endif
	{ ecmd_df_status_text, parse_cmd_df_status },
	{ ecmd_fs_format_text, parse_cmd_fs_format },
	{ ecmd_fs_list_text, parse_cmd_fs_list },
	{ ecmd_fs_mkfile_text, parse_cmd_fs_mkfile },
	{ ecmd_fs_remove_text, parse_cmd_fs_remove },
	{ ecmd_fs_truncate_text, parse_cmd_fs_truncate },
#ifdef DEBUG_FS
	{ ecmd_fs_inspect_node_text, parse_cmd_fs_inspect_node },
	{ ecmd_fs_inspect_inode_text, parse_cmd_fs_inspect_inode },
#endif
#ifndef TEENSY_SUPPORT
#ifdef UIP_SUPPORT
#ifndef IPV6_SUPPORT
...
#endif
#endif
	{ ecmd_ntp_query_text, parse_cmd_ntp_query },
	{ ecmd_ntp_server_text, parse_cmd_ntp_server },
	{ ecmd_ntp_status_text, parse_cmd_ntp_status },
#ifdef I2C_DETECT_SUPPORT
	{ ecmd_i2c_detect_text, parse_cmd_i2c_detect },
#endif
#ifdef I2C_GENERIC_SUPPORT
