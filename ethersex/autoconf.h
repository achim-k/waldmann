...
#define set_CONF_ENC_IP(ip) uip_ipaddr((ip), 192,168,0,90 )
#define CONF_ENC_IP "192.168.0.90"
...
#define ENC28J60_SUPPORT 1
#define CONF_ENC_MAC  "\xac\xde\x48\xfd\x0f\xd0"
#undef  IPV6_STATIC_SUPPORT
#define set_CONF_ENC_IP(ip) uip_ipaddr((ip), 192,168,23,244 )
#define CONF_ENC_IP "192.168.23.244"
#define set_CONF_ENC_IP4_NETMASK(ip) uip_ipaddr((ip), 255,255,255,0 )
#define CONF_ENC_IP4_NETMASK "255.255.255.0"
#undef  IEEE8021Q_SUPPORT
#undef  DEBUG_ENC28J60
...
#undef  IP_FORWARDING_SUPPORT
#undef  UIP_TIMEOUT_SUPPORT
#define set_CONF_ETHERRAPE_GATEWAY(ip) uip_ipaddr((ip), 192,168,23,1 )
#define CONF_ETHERRAPE_GATEWAY "192.168.23.1"
#undef  UIP_MULTI_STACK
#undef  IPCHAIR_SUPPORT
#undef  IPCHAIR_MASQ
#define TCP_SUPPORT 1
...
#define CONF_OPENVPN_KEY "\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00"
#define CONF_OPENVPN_HMAC_KEY "\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00"
#define set_CONF_OPENVPN_IP(ip) uip_ipaddr((ip), 192,168,23,244 )
#define CONF_OPENVPN_IP "192.168.23.244"
#define set_CONF_OPENVPN_IP4_NETMASK(ip) uip_ipaddr((ip), 255,255,255,0 )
#define CONF_OPENVPN_IP4_NETMASK "255.255.255.0"
#undef  OPENVPN_STATIC_REMOTE
#undef  DEBUG_NET
...
#define set_NTP_SERVER_IP(ip) uip_ipaddr((ip), 213,133,123,125 )
#define NTP_SERVER_IP "213.133.123.125"
#define NTP_PORT (123)
#define NTP_QUERY_INTERVAL (1800)
#undef  NTPD_SUPPORT
#undef  WHM_SUPPORT
#undef  UPTIME_SUPPORT
#define TIMEZONE TIMEZONE_UTC
